...
|Trigger|When|Action|
|-|-|-|
|Task-start|Before reading design|Check `communication/ai_status.md` Human Input section|
|Pre-impl|Before modifying files|Check `communication/ai_status.md` Human Input section|
|Pre-handoff|Before creating handoff|Check `communication/ai_status.md` Human Input section|

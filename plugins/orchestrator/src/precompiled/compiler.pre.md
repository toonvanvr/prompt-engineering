...
Transforms `plugins/orchestrator/src/*.src.md` → `plugins/orchestrator/agents/*.agent.md` via research-backed compression. One-way operation — always keep source files.
...
<!-- @source plugins/orchestrator/src/shared/glossary.md L1-L20 -->
## Glossary
...
<!-- @source plugins/orchestrator/src/shared/glossary.md L1-L20 (duplicate — already resolved above) -->
...
> Detail tables: `plugins/orchestrator/src/reference/compression-tables.md` — full rules, examples, patterns. Included via `@include` during compilation.
...
> Full schema: `plugins/orchestrator/src/reference/frontmatter-schema.md`
...
|`plugins/orchestrator/src/reference/compression-tables.md`|Compression rules and patterns|
